...
This command prepares the `Debug` target set for the `MyBoard_ROM` target and downloads missing packs.

```bash
> cbuild setup CubeMX.csolution.yml --active MyBoard_ROM@Debug --packs
```
